...

{
  ...
  "suggestedPrompt": "A short, helpful follow-up prompt the user can use to refine or adjust the migration. For example: 'Refactor to use interceptors instead of direct HttpClient calls.'"
}
